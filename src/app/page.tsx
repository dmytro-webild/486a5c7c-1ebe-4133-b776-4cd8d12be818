      ...
      features={[
        {
          ...
          description: "Sourced from the finest local and traditional suppliers for unmatched taste.",
          icon: Shield,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Authentic charcoal grilling and slow-cooking techniques preserved for decades.",
          icon: Award,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Our team treats every guest like family in an elegant, cozy atmosphere.",
          icon: Heart,
          mediaItems: [
            {
